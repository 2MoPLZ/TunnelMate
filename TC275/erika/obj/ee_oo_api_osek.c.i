# 1 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
# 1 "C:\\TunnelMate\\TC275\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
# 53 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
...
# 54 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c" 2
...
# 300 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
    p_ccb->os_status = OSEE_KERNEL_STARTING;
    p_ccb->app_mode = real_mode;
# 389 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
    osEE_call_startup_hook(p_ccb);
# 527 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
    ...
    for(;;) {}
# 572 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  }
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 655 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
...
# 691 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 745 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_tid(p_kdb, TaskID)) {
    ev = E_OS_ID;
  } else {
    OsEE_TDB * const
      p_tdb_act = (*p_kdb->p_tdb_ptr_array)[TaskID];
# 771 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
    if (p_tdb_act->task_type <= OSEE_TASK_TYPE_EXTENDED) {
      OsEE_reg flags;
...
# 819 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  OsEE_TDB * const
    p_curr = p_ccb->p_curr;
# 898 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  {
    OsEE_reg flags;
...
# 934 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1003 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
...
# 1034 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1083 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  ...
  } else
  {
    ...
    OsEE_reg
      flags = osEE_begin_primitive();
# 1117 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
    {
...
# 1146 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1191 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_res_id(p_kdb, ResID)) {
    ev = E_OS_ID;
  } else
  {
    ...
    OsEE_ResourceCB * const
      p_reso_cb = p_reso_db->p_cb;
# 1213 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
    {
      OsEE_reg
        flags = osEE_begin_primitive();
...
# 1256 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1304 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  {
    if ((os_status == OSEE_KERNEL_STARTED) ||
...
# 1323 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1373 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  if (TaskID == ((void *)0)) {
    ...
    OsEE_TDB * const
      p_tdb = p_ccb->p_curr;
# 1389 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
...
# 1428 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1479 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  if (State == ((void *)0)) {
    ev = E_OS_PARAM_POINTER;
  } else
  if (!osEE_is_valid_tid(p_kdb, TaskID)) {
...
# 1526 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  osEE_orti_trace_service_exit(p_ccb, OSServiceId_GetTaskState);

  return ev;
}
# 1940 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
StatusType
  WaitEvent
(
  EventMaskType Mask
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2002 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  {
...
# 2044 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  OsEE_CDB * const
    p_cdb = osEE_get_curr_core();
# 2101 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  osEE_stack_monitoring(p_cdb);
...
# 2140 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  OsEE_CDB * const
    p_cdb = osEE_get_curr_core();
# 2200 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  osEE_stack_monitoring(p_cdb);
...
# 2220 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
    if (Event == ((void *)0)) {
      ev = E_OS_PARAM_POINTER;
    } else
    {
...
# 2246 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  return ev;
}
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2298 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  {
...
# 2323 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
  osEE_orti_trace_service_exit(p_ccb, OSServiceId_ClearEvent);

  return ev;
}
# 3311 "C:\\TUNNEL~1\\TC275\\erika\\src\\ee_oo_api_osek.c"
ISRType
  GetISRID
(
  void
